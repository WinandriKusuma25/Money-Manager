<!-- <?= 
    ...
    <body background =  "<?=base_url();?>./asset/images/background_login.jpg">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-8">
                <div class="account-wall">
                    ...
                    <form class="form-signin" method="POST" action="<?=base_url();?>login/proses_login" role="form" autocomplete="off" id="formlogin" >
                        ...
                        <div class="form-group">
                                    <div class="g-recaptcha" data-sitekey="6LcMctIZAAAAAAWvk-WKOpm-RE-MVFX50NP3cfk1"></div>
                                </div>
                                <br>
                    ...
                    <a href="<?=base_url("register");?>" class="text-center new-account">Buat Akun Baru </a>
