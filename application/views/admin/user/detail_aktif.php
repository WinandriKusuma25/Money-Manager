  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-primary"><i class="fas fa-users"></i>&nbsp;Detail Users</h1>
          </div>
          <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
          <li  class="m-0 text-muted"><a>Dashboard /&nbsp; </a></li>
              <li class="m-0 text-muted">&nbsp;Users /&nbsp; </li>
              <li class="m-0 text-muted">&nbsp;Daftar User Aktif /&nbsp; </li>
              <li class="m-0 text-primary">&nbsp;Detail Users</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="alert alert-secondary" role="alert">
              Berikut merupakan detail user yang ada dalam Website Money Manager
            </div>
            </div>
            </div>
            </div>
              ...
              <!-- /.card-header -->
               <?php $no=1; foreach ($user as $pmj): ?>
                ...
                <table class="table">
                    ...
                    <br>
                    <a href="<?= base_url("register/tabel_register_aktif")?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> &nbsp;Kembali</a>
                  </div>
                <?php endforeach ?>
                </div>
                <!-- /.card-body -->
